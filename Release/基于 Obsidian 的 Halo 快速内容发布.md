...
auther: xchenning
cover: https://img.glcn.top/piclist/1721225505852-4278cae41f334f139c6748db8f96ad66.png
...
halo:
  ...
  name: bf3442c3-30cc-4197-934a-75d59341b011
  publish: true
---

闲的没事，终于又把之前挂了的Blog又建回来了，之前使用 [obsidian](https://obsidian.md/) + [verysync](https://www.verysync.com/) + [mkdocs](https://www.mkdocs.org/) + [docker](https://www.docker.com/)的笔记方案，为的就是写啥上传啥，省心，但是缺了点东西，纯docs不好玩。
...
![image.png](https://img.glcn.top/piclist/1721224478962-83929f2e80de4078bd2405a3e4f72073.png)

首先把`管理页面自动导入配置`开开

![image.png](https://img.glcn.top/piclist/1721224626888-f6a3ea82539d414f83c414f805ce44ef.png)

然后在`图床`页配置好图床就完全好了，`管理`页配置就会自动载入

记得把存储路径设置为`<文件夹名>/`，后面的斜杠才是新建一个这样的文件夹，其他地方加的话自行摸索，七牛云是可以`//`连续两个根目录（没名字的目录），到时候会出问题。

![image.png](https://img.glcn.top/piclist/1721224922747-8ae19655ce664fc4bffe5b0f061b5265.png)

然后记得改`上传设置`的重命名，上传图片不要使用默认名字，到时候文件名有空格的话处理起来很麻烦（到时候就一个个查找替换了）

可以上传一张图片试试能不能成功

piclist客户端的话，会自动后台挂住`https://127.0.0.1:36677/`，到时候Obsidian依赖这个来上传图片
...
![image.png](https://img.glcn.top/piclist/1721225505852-4278cae41f334f139c6748db8f96ad66.png)
...
![image.png](https://img.glcn.top/piclist/1721225312188-768cdf6a05df4aeb97612d47b6923eb1.png)
